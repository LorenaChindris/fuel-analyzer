...
public class Log {
    ...
    // the values from Android's native logging facilities,
    // for easy migration and interoperability
    ...
    /**
     * Instructs the LogNode to print the provided log data. Other LogNodes can
