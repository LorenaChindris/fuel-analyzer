...
public class LogWrapper implements LogNode {
    ...
    // for piping purposes - the next node to receive Log data after this one has done its work
    ...
    public void println(int priority, String tag, String msg, Throwable tr) {
        // there actually are log methods that don't take a msg parameter
        // if that's the case, just convert null to the empty string
        String useMsg = msg;
        if (useMsg == null) {
            useMsg = "";
        }
